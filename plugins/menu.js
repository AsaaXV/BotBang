...
┗━━━━━━━━⬣`.trim(),
    ...
    await conn.send3ButtonLoc(m.chat, await (await fetch(`https://telegra.ph/file/c4385b1b2134bcec6cceb.jpg`)).buffer(), text.trim(), 'Recoded By FaturGanz', '👤 Pemilik Bot', '.owner', '💵 Donasi', '.donasi', '📜 Rules', '.infobot', m)
